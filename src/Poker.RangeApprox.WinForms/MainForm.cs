...
public sealed class MainForm : Form
{
    ...
    private Control BuildLeftPanel()
    {
        ...
        AddStandardRow(
            ...
            "Run output directory generated by the app after execution starts.\r\n\r\nUse Open Visualization to browse a saved .rangeviz file.");
        var viewButton = new Button
        {
            Text = "Open Range Viewer",
            Width = 160,
            Height = 32
        };
        ...
        {
            var viewer = new RangeVisualizationForm();
            viewer.Show();
        };

        _inputLayout.Controls.Add(viewButton, 2, OutputRootRow);
    ...
    private void BindHelpText()
    {
        ...
        BindHelp(_openVisualizationButton, "Open an existing .rangeviz file in the range visualization viewer.");
    }
    ...
    private void OpenVisualizationFile()
    {
        ...
        if (!string.IsNullOrWhiteSpace(_outputRootTextBox.Text) && Directory.Exists(_outputRootTextBox.Text))
        {
            dialog.InitialDirectory = _outputRootTextBox.Text;
        }
        ...
        try
        {
            ...
            var document = reader.Read(dialog.FileName);
